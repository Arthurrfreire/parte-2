  ...
  return (
    <>
      ...
      <section
        ...
        className="relative isolate flex min-h-[100svh] items-center bg-[radial-gradient(circle_at_78%_18%,rgba(207,45,92,0.22),transparent_28rem),radial-gradient(circle_at_10%_16%,rgba(120,20,54,0.24),transparent_24rem),linear-gradient(180deg,#050706_0%,#12060b_100%)] px-5 py-8 sm:px-8 lg:px-12"
      >
        ...
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-10 pt-8 lg:grid lg:grid-cols-[1.02fr_0.98fr] lg:items-center lg:gap-14 lg:pt-10">
          <div className="max-w-3xl">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <a
                href="#matricula"
                className="inline-flex min-h-16 w-full items-center justify-center rounded-[28px] border border-[#ffadc5] bg-[#cf2d5c] px-8 text-lg font-bold text-white shadow-[0_16px_0_#050706] transition hover:translate-y-1 hover:bg-[#e03a6d] hover:shadow-[0_10px_0_#050706] active:translate-y-3 active:shadow-[0_4px_0_#050706] focus-visible:outline-[#ffadc5] sm:w-auto sm:min-w-[330px]"
              >
                Quero comecar agora
              </a>
              <a
                href="#conteudo"
                className="inline-flex min-h-16 w-full items-center justify-center rounded-[28px] border border-white/28 bg-white/[0.04] px-8 text-lg font-bold text-white shadow-[0_16px_0_#050706] transition hover:translate-y-1 hover:border-[#ffadc5]/70 hover:bg-white/[0.1] hover:shadow-[0_10px_0_#050706] active:translate-y-3 active:shadow-[0_4px_0_#050706] focus-visible:outline-[#ffadc5] sm:w-auto sm:min-w-[330px]"
              >
